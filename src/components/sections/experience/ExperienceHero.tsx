...
import heroImg from '../../../assets/Bambus-erleben-page-banner.jpg';
    ...
    <section className="relative min-h-[80vh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container-site pt-20">
        <div className="max-w-4xl">
          ...
          >
            Experience <br />
            <span className="text-italic-accent font-normal">the power of bamboo</span>
          </h1>
          <p 
            className={cn(
          ...
          >
            Discover why bamboo is the future of sustainable outdoor living.
          </p>
        </div>
      </div>
